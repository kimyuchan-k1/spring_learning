...
public class OrderQueryRepository {
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery(
                "select  new" +
                        " jpabook.jpashop.order.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                        " from OrderItem oi" +
                        " join oi.item i" +
    ...
    public List<OrderQueryDto> findAllByDto_optimization() {
        ...
        // 생성한 map collections 의 id 와 일치하는 orderid에 orderItem 추가
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        ...
        List<OrderItemQueryDto> orderItems = em.createQuery(
                "select new jpabook.jpashop.order.query.OrderItemQueryDto(" +
    ...
    public List<OrderFlatDto> findAllByDto_flat()    {
        return em.createQuery(
                "select new jpabook.jpashop.order.query.OrderFlatDto(" +
